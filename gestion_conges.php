...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $congeExceptionnel = isset($_POST['congeExceptionnel']) ? $_POST['congeExceptionnel'] : 0;
    ...
    if ($dateDebut >= $dateToday && $dateFin >= $dateDebut) {
        ...
        if ($daysRequested <= $joursRestants) {
            ...
            $stmt = $conn->prepare("INSERT INTO conge (matricule, dateDebut, dateFin, justificatif, statut) VALUES (?, ?, ?, ?, 'En attente')");
